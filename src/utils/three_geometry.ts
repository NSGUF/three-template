 ...
 * @param width 大小
 */
export function getHedron (type: HEDRON_TYPE, width: number, detail = 0) {
    if (!type) {
        throw 'type参数必须传入';
    }
    let result;
...
export function getHedronMesh (type: HEDRON_TYPE, color: number, width: number, detail = 0) {
    ...
    return SceneUtils.createMultiMaterialObject(headron, [material, frameMaterial]);
}
...
export function getIcosahedronPoint (color = 0xfffff, width = 30, detail = 0) {
    return getHedronPoint(HEDRON_TYPE.Icosahedron, color, width, detail);
}

export function getDodecahedronPoint (color = 0xfffff, width = 30, detail = 0) {
    return getHedronPoint(HEDRON_TYPE.Dodecahedron, color, width, detail);
}

export function getOctahedronPoint (color = 0xfffff, width = 30, detail = 0) {
    return getHedronPoint(HEDRON_TYPE.Octahedron, color, width, detail);
}

export function getTetrahedronPoint (color = 0xfffff, width = 30, detail = 0) {
 ...
 * @param width 宽度
 */
export function getHedronPoint (type: HEDRON_TYPE, color = 0xfffff, width = 30, detail = 0) {
